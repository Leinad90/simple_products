<?php
// source: /home/dan/public_html/Products/config/common.neon
// source: /home/dan/public_html/Products/config/services.neon
// source: array
...
class Container_f4cccad8cd extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'UnitEnum' => [['02']],
		'BackedEnum' => [['02']],
		'App\Model\Enum\ProductDrivers' => [['02']],
	...
	public function createService02(): App\Model\Enum\ProductDrivers
	{
		return App\Model\Enum\ProductDrivers::from('prdel');
	}


	public function createService03(): App\Model\ProductsModel
	{
		return new App\Model\ProductsModel($this->getService('02'), $this->getService('cache.storage'));
	}
	...
	public function createServiceApplication__4(): App\UI\Product\ProductPresenter
	{
		$service = new App\UI\Product\ProductPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
		...
		$service->Products = $this->getService('03');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/dan/public_html/Products/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/dan/public_html/Products/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_f4cccad8cd $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/dan/public_html/Products/temp/cache/latte');
